...
export function PlantViewer({ plant, selectedPart, onPartClick, onPartDoubleClick, isMobile }: PlantViewerProps) {
  ...
  return (
    <div className="flex-1 relative flex flex-col items-center justify-start p-4 sm:p-8 overflow-y-auto custom-scrollbar">
      ...
      <div className="w-full flex justify-center items-center py-4 mt-16 sm:mt-20">
        <div 
          style={{
        ...
        >
          <img
            ...
            className={`block w-auto h-auto max-w-full max-h-[60vh] sm:max-h-[70vh] md:max-h-[calc(100vh-220px)] object-contain transition-all duration-500 ease-out select-none ${
      ...
      {/* "How to use this explorer" Guide Section (Fills empty vertical space underneath the photo elegantly) */}
      <div className="w-full max-w-xl bg-white/60 dark:bg-stone-900/40 backdrop-blur-sm border border-stone-200/50 dark:border-stone-800/50 rounded-2xl p-4 sm:p-5 mt-4 mb-16 transition-all duration-300 select-none">
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 text-[11px] sm:text-xs text-stone-600 dark:text-stone-400">
          <li className="flex items-start gap-2.5">
            ...
            <p className="leading-relaxed">
              {language === 'ms' 
                ? 'Tuding atau dwi-ketik pada imej tumbuhan untuk melihat kawasan interaktif diserlahkan.' 
                : 'Hover or double-tap on the plant image to see interactive highlighted regions.'}
            </p>
          </li>
          <li className="flex items-start gap-2.5">
